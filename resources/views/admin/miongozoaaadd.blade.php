              ...
              <div class="col-12">
                ...
                {{ csrf_field() }}
                    <div class="card-header">
                      <h4>SAJILI MIONGOZO</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                <label>JINA LA MIONGOZO<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" name="name" value="{{ old('name')}}" placeholder="JINA LA MIONGOZO"  required>
