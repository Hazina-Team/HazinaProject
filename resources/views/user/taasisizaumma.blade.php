      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">TAASISI ZA UWEKEZAJI ZA UMMA</li>
          </ol>
        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-header bg-gradient-success shadow-primary border-radius-lg pt-2 pb-1">
                    <h6 class="text-white text-capitalize ps-3">LISTI ZA TAASISI ZA UWEKEZAJI ZA MASHIRIKA</h6>
                </div>
                        ...
                        <table class="table align-items-center mb-0 table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Jina la Taasisi</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Aina Ya Taasisi</th>
                                ...
                                @foreach($getRecord as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('user/taasisizote/'.$value->id)}}" class="btn btn-success btn-sm" type="button">
                                                <i class="nav-icon fas fa-eye"></i> ANGALIA ZAID
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
